...
// 剧情走向（合并版 = 原版火星主线 + 新增航天/月球续集）：
//   地球发射 → 太空(陨石风暴/大便兽/长角兽军团→登船) → 火星(怪物群/大蜘蛛兽) → 神秘城堡 → 光头强(普通,中级Boss)
//   → 月球探险 → 魔鬼兽 → 大蜘蛛兽 → 大螃蟹兽 → 中级蜘蛛兽(骷髅头) → 巨型时间吞噬者(光头强巨化,最终)
var STAGES = [
  {
  ...
  {
    // 第 8 幕：城堡内部，大魔王光头强（普通体型，二阶段）。打败他后他巨化逃往月球！
    name: '第 8 幕 城堡内·光头强',
    theme: 'castle',
    width: 1600,
    gravity: 0.6,
    ...
    goal: 'boss',
    tip: '大魔王光头强！先用弱难度削他，血量过半他会生气（第二阶段更猛），小心电锯和木屑气浪。打败他后他巨化逃往月球——追上月球决战！'
  },
  {
    // 第 9 幕：月球！大雪球小雪球滚下来、房子从天上掉，跳过大便兽，穿过两面旗，躲开掉落的房子
    name: '第 9 幕 月球探险',
    theme: 'moon',
    width: 5400,
    gravity: 0.62,
    ...
    flag: { x: 5240, y: 588 },      // 月球终点旗 → 进入魔鬼兽
    ship: null,
    castle: null,
    boss: null,
    goal: 'flag',
    tip: '光头强逃到了月球！月球上大雪球小雪球滚下来、房子从天上掉！跳过大便兽，穿过两面旗，躲开掉落的房子，走到终点旗'
  },
  {
    // 第 10 幕：魔鬼兽（红色飞行小恶魔）
    name: '第 10 幕 魔鬼兽',
  ...
  {
    // 第 13 幕：中级蜘蛛兽（骷髅头蜘蛛兽）—— 打完大螃蟹兽后、挑战最终 Boss 前的关卡
    name: '第 13 幕 中级蜘蛛兽（骷髅头）',
    theme: 'moon',
    width: 1600,
    gravity: 0.62,
    jumpVel: 18.4,
