...
final class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        //    **前半句对，后半句的含义错了。**
        //
        //    模拟器实测系统自带键盘那条下巴（iOS 26.5，避开地球/麦克风图标取中段）：
        //      浅色外观  RGB (223,224,230)  亮度 226
        //      深色外观  RGB ( 27, 27, 29)  亮度  28
        //    → **系统根本没有强制白色，它跟着外观走。**
        //      白，是因为**我们的键盘跑在浅色外观下**（他手机是浅色模式），
        //      而我们自己是深色主题，所以那条带子显得格格不入。
        //
        //    我们全套配色本来就是深色（`Theme.bg` 是深的），
